...
load("LBB1__RgSet_Methylumi_Pheno_EC107_PFC114_STG117.Rdata")
###################################
###################################
###################################
#######LBB1.PFC
setwd("/mnt/data1/Ehsan/meta_CrossCortical/LBB1/PFC/QC")
###### QC.1#######
rgSet<-rgSet.PFC
Methylumiset<-LBB1.PFC
pheno<-pheno.LBB1.PFC
rm(rgSet.PFC,LBB1.PFC, pheno.LBB1.PFC)
...
#                     X  sample Age Gender Braak CC  cellprop region Cohort
#867  6042316048_R05C02 A169/05  82      2     6  1 0.3878419    PFC   LBB1
#1005 6042316110_R06C02 A187/07  94      2     5  1 0.3773996    PFC   LBB1
###################################
###################################
###################################
BAD.genetic.relationship<-"6042316048_R05C02"
###################################
###################################
###################################
...
#Samples removed:  
#   270 sites were removed as beadcount <3 in 5 % of samples 
#   409 sites having 1 % of samples with a detection p-value greater than 0.05 were removed 
###################################
###################################
###################################
...
identical(as.character(colnames(betas.dasen)), as.character(pheno$X))
#[1] TRUE
###################################
###################################
###################################
...
save(betas,pheno, file="LBB1.PFC.113.beta.pheno.Rdata")
#TRUE
###################################
###################################
###################################
setwd("/mnt/data1/Ehsan/meta_CrossCortical/NORMALISED_BETA")
load("LBB1.PFC.113.beta.pheno.Rdata")
...
save(dat.reg,pheno, file="LBB1.PFC.109.pheno.REGRESSED.Rdata")
###################################
###################################
###################################
rm(list=ls())
...
save(sva, file="sva.regressed.lbb1.pfc.Rdata")

setwd("/mnt/data1/Ehsan/meta_CrossCortical/SVA/")
load("sva.regressed.lbb1.pfc.Rdata")
svs<-sva$sv
pheno.LBB<-cbind(pheno, svs)

setwd("/mnt/data1/Ehsan/meta_CrossCortical/pheno/")
write.csv(pheno.LBB,file="pheno.LBB1.PFC.109.csv")
...
###################################
#######LBB1.EC
setwd("/mnt/data1/Ehsan/meta_CrossCortical/LBB1/EC/QC")
###################################
###################################
###################################
rgSet<-rgSet.EC
Methylumiset<-LBB1.EC
pheno<-pheno.LBB1.EC
...
pheno[which(genetic.cor[,1] > 0.65),]
genetic.cor[which(genetic.cor[,1] > 0.65),]
BAD.genetic.relationship<-"6969568084_R06C01"
###################################
###################################
###################################
bad<-c(BAD.samples.Bisulifite,BAD.BckgIntensityDiffPval,BAD.samples.Intensity,BAD.genetic.relationship,BAD.samples.sexMissmatch)
# didnt include sexmismatch 
bad<-unique(bad)
save(bad,BAD.samples.Bisulifite,BAD.BckgIntensityDiffPval,BAD.samples.Intensity,BAD.genetic.relationship, BAD.samples.sexMissmatch,
     file="bad.samples.Rdata")
###################################
###################################
###################################
...
#0 samples having 5 % of sites with a detection p-value greater than 0.05 were removed 
#Samples removed:  
#   416 sites were removed as beadcount <3 in 5 % of samples 
#   1472 sites having 1 % of samples with a detection p-value greater than 0.05 were removed 
###################################
###################################
###################################
dat.dasen<-dasen(dat.pf)
...
colnames(betas)<-as.character(pheno$X)
setwd("/mnt/data1/Ehsan/meta_CrossCortical/NORMALISED_BETA")
save(betas,pheno, file="LBB1.EC.105.beta.pheno.Rdata")
#TRUE
...
rm(list=ls())
setwd("/mnt/data1/Ehsan/meta_CrossCortical/NORMALISED_BETA")
load("LBB1.EC.105.beta.pheno.Rdata")
resid <- function( row, age, sex, cet ){
...
setwd("/mnt/data1/Ehsan/meta_CrossCortical/REGRESSED_BETA")
save(dat.reg,pheno, file="LBB1.EC.101.pheno.REGRESSED.Rdata")
###################################
###################################
###################################
...
sva<- sva::sva(dat = as.matrix(mydf), mod = mod, mod0 = mod0)
setwd("/mnt/data1/Ehsan/meta_CrossCortical/SVA/")
save(sva, file="sva.regressed.lbb1.ec.Rdata")
###################################
###################################
###################################
setwd("/mnt/data1/Ehsan/meta_CrossCortical/SVA/")
load("sva.regressed.lbb1.ec.Rdata")

svs<-data.frame(sva$sv)
pheno.LBB<-cbind(pheno, svs)

setwd("/mnt/data1/Ehsan/meta_CrossCortical/pheno/")
write.csv(pheno.LBB,file="pheno.LBB1.EC.101.csv")
...
###################################
#######LBB1.STG
setwd("/mnt/data1/Ehsan/meta_CrossCortical/LBB1/STG/QC")
###################################
###################################
###################################
rgSet<-rgSet.STG
Methylumiset<-LBB1.STG
pheno<-pheno.LBB1.STG
...
pheno[which(genetic.cor[,1] > 0.65),]
genetic.cor[which(genetic.cor[,1] > 0.65),]
BAD.genetic.relationship<-"6042316036_R04C01"
###################################
###################################
###################################
bad<-c(BAD.samples.Bisulifite,BAD.BckgIntensityDiffPval,BAD.samples.Intensity,BAD.genetic.relationship,BAD.samples.sexMissmatch)
...
#0 samples having 5 % of sites with a detection p-value greater than 0.05 were removed 
#Samples removed:  
#   769 sites were removed as beadcount <3 in 5 % of samples 
#   1830 sites having 1 % of samples with a detection p-value greater than 0.05 were removed
###################################
###################################
###################################
dat.dasen<-dasen(dat.pf)
...
colnames(betas)<-as.character(pheno$X)
setwd("/mnt/data1/Ehsan/meta_CrossCortical/NORMALISED_BETA")
save(betas,pheno, file="LBB1.STG.116.beta.pheno.Rdata")
#TRUE
###################################
###################################
###################################
setwd("/mnt/data1/Ehsan/meta_CrossCortical/NORMALISED_BETA")
load("LBB1.STG.116.beta.pheno.Rdata")
resid <- function( row, age, sex, cet ){
...
setwd("/mnt/data1/Ehsan/meta_CrossCortical/REGRESSED_BETA")
save(dat.reg,pheno, file="LBB1.STG.112.pheno.REGRESSED.Rdata")
###################################
###################################
###################################
rm(list=ls())
...
sva<- sva::sva(dat = as.matrix(mydf), mod = mod, mod0 = mod0)
setwd("/mnt/data1/Ehsan/meta_CrossCortical/SVA/")
save(sva, file="sva.regressed.lbb1.stg.Rdata")

setwd("/mnt/data1/Ehsan/meta_CrossCortical/SVA/")
load("sva.regressed.lbb1.stg.Rdata")

svs<-data.frame(sva$sv)
pheno.LBB<-cbind(pheno, svs)

setwd("/mnt/data1/Ehsan/meta_CrossCortical/pheno/")
write.csv(pheno.LBB,file="pheno.LBB1.STG.112.csv")
###################################
###################################
###################################