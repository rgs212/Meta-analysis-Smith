...
load("LBB2__RgSet_Methylumi_Pheno_EC92.Rdata")
###################################
#######LBB2.EC
setwd("/mnt/data1/Ehsan/meta_CrossCortical/LBB2/QC")
###### QC.1#######
rgSet<-rgSet.EC.2
Methylumiset<-LBB2.EC
pheno<-pheno.LBB2.EC
...
BAD.genetic.relationship<-"3999492090_R02C01"
############################################################################
############################################################################
############################################################################
...
save(betas,pheno, file="LBB2.EC.88.beta.pheno.Rdata")
#TRUE
...
save(dat.reg,pheno, file="LBB2.EC.87.pheno.REGRESSED.Rdata")
...
save(sva, file="sva.regressed.lbb2.ec.Rdata")
...
#[1] TRUE
setwd("/mnt/data1/Ehsan/meta_CrossCortical/SVA/")
load("sva.regressed.lbb2.ec.Rdata")

svs<-data.frame(sva$sv)
pheno.LBB2<-cbind(pheno, svs)

setwd("/mnt/data1/Ehsan/meta_CrossCortical/pheno/")
write.csv(pheno.LBB2,file="pheno.LBB2.EC.88.csv")
