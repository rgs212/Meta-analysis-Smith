...
load("AZ1_RgSet_Methylumi_Pheno_309.Rdata")
###################################
#######AZ1
setwd("/mnt/data1/Ehsan/meta_CrossCortical/AZ1/QC")
###### QC.1#######
rgSet<-rgsetAZ1
Methylumiset<-AZ1
pheno<-pheno.AZ1
...
identical(colnames(Methylumiset), as.character(pheno$CompleteBarcode))
#[1] TRUE
...
#[1] "6055432165_R05C01" "6057833010_R01C01"
BAD.genetic.relationship<-"6057833010_R01C01"
...
#Samples removed:  
#   654 sites were removed as beadcount <3 in 5 % of samples 
#   8771 sites having 1 % of samples with a detection p-value greater than 0.05 were removed 
...
save(betas,pheno, file="AZ1.MTG.267.beta.pheno.Rdata")
#TRUE
...
save(dat.reg,pheno, file="AZ1.MTG.265.pheno.REGRESSED.Rdata")
...
save(sva, file="sva.regressed.az1.mtg.Rdata")

svs<-sva$sv
pheno.AZ1<-cbind(pheno, svs)

setwd("/mnt/data1/Ehsan/meta_CrossCortical/pheno/")
write.csv(pheno.AZ1,file="pheno.AZ1.265.csv")
